...
type ConversationMsg struct {
	...
	UnreadCount   int64 `protobuf:"varint,8,opt,name=unreadCount,proto3" json:"unreadCount"`
...
func (x *ConversationMsg) GetUnreadCount() int64 {
	if x != nil {
...
const file_jssdk_jssdk_proto_rawDesc = "" +
	"\n" +
	"\x11jssdk/jssdk.proto\x12\fopenim.jssdk\x1a\x11sdkws/sdkws.proto\x1a\x17relation/relation.proto\x1a\x1fconversation/conversation.proto\"\xf1\x02\n" +
	...
	"\areadSeq\x18\a \x01(\x03R\areadSeq\x12 \n" +
	"\vunreadCount\x18\b \x01(\x03R\vunreadCount\"S\n" +
