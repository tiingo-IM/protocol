...
type MessageReactionChange struct {
	...
	Reactions []*ReactionCount `protobuf:"bytes,4,rep,name=reactions,proto3" json:"reactions"`
	...
	ChangedUserIDs []string `protobuf:"bytes,5,rep,name=changedUserIDs,proto3" json:"changedUserIDs"`
	...
	ChangedUsersTruncated bool `protobuf:"varint,6,opt,name=changedUsersTruncated,proto3" json:"changedUsersTruncated"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *MessageReactionChange) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MessageReactionChange) GetClientMsgID() string {
	if x != nil {
		return x.ClientMsgID
	}
	return ""
...
func (x *MessageReactionChange) GetVersion() int64 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *MessageReactionChange) GetReactions() []*ReactionCount {
	if x != nil {
		return x.Reactions
	}
	return nil
...
func (x *MessageReactionChange) GetChangedUserIDs() []string {
	if x != nil {
		return x.ChangedUserIDs
	}
	return nil
}

func (x *MessageReactionChange) GetChangedUsersTruncated() bool {
	if x != nil {
		return x.ChangedUsersTruncated
	}
	return false
}
...
type MessageReactionsChangedTips struct {
	state          protoimpl.MessageState   `protogen:"open.v1"`
	ConversationID string                   `protobuf:"bytes,1,opt,name=conversationID,proto3" json:"conversationID"`
	...
	Changes        []*MessageReactionChange `protobuf:"bytes,4,rep,name=changes,proto3" json:"changes"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MessageReactionsChangedTips) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MessageReactionsChangedTips) GetSessionType() int32 {
	if x != nil {
...
func (x *MessageReactionsChangedTips) GetGroupID() string {
	if x != nil {
		return x.GroupID
	}
	return ""
...
func (x *MessageReactionsChangedTips) GetChanges() []*MessageReactionChange {
	if x != nil {
		return x.Changes
	}
	return nil
...
const file_sdkws_sdkws_proto_rawDesc = "" +
	...
	"\x15MessageReactionChange\x12\x10\n" +
	"\x03seq\x18\x01 \x01(\x03R\x03seq\x12 \n" +
	"\vclientMsgID\x18\x02 \x01(\tR\vclientMsgID\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x03R\aversion\x129\n" +
	"\treactions\x18\x04 \x03(\v2\x1b.openim.sdkws.ReactionCountR\treactions\x12&\n" +
	"\x0echangedUserIDs\x18\x05 \x03(\tR\x0echangedUserIDs\x124\n" +
	"\x15changedUsersTruncated\x18\x06 \x01(\bR\x15changedUsersTruncated\"\xc0\x01\n" +
	"\x1bMessageReactionsChangedTips\x12&\n" +
	...
	"\achanges\x18\x04 \x03(\v2#.openim.sdkws.MessageReactionChangeR\achanges\"\x86\x02\n" +
