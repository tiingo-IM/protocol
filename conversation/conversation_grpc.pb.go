...
func (c *conversationClient) GetNotificationSeqCounts(ctx context.Context, in *GetNotificationSeqCountsReq, opts ...grpc.CallOption) (*GetNotificationSeqCountsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetNotificationSeqCountsResp)
	err := c.cc.Invoke(ctx, Conversation_GetNotificationSeqCounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Conversation_GetNotificationSeqCounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNotificationSeqCountsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationServer).GetNotificationSeqCounts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Conversation_GetNotificationSeqCounts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationServer).GetNotificationSeqCounts(ctx, req.(*GetNotificationSeqCountsReq))
	}
	return interceptor(ctx, in, info, handler)
}
