...
func (c *thirdClient) UpdatePushToken(ctx context.Context, in *UpdatePushTokenReq, opts ...grpc.CallOption) (*UpdatePushTokenResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdatePushTokenResp)
	err := c.cc.Invoke(ctx, Third_UpdatePushToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedThirdServer) UpdatePushToken(context.Context, *UpdatePushTokenReq) (*UpdatePushTokenResp, error) {
...
func _Third_UpdatePushToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePushTokenReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThirdServer).UpdatePushToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Third_UpdatePushToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThirdServer).UpdatePushToken(ctx, req.(*UpdatePushTokenReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Third_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Third_UpdatePushToken_Handler,
		},
		{
