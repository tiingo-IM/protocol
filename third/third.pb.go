...
// UpdatePushTokenReq registers one push channel of one device: FCM, or a
// phone maker's own push service (hms, honor, xiaomi, oppo, vivo). A
// device may hold one token per vendor at once; the push service picks
// the channel. region is where the vendor's server keeps this token
// (Xiaomi and OPPO run separate China and global services), locale is
// the language the device shows, for the pushes the server has to word
// itself.
type UpdatePushTokenReq struct {
	...
	ExpireTime    int64                  `protobuf:"varint,7,opt,name=expireTime,proto3" json:"expireTime"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdatePushTokenReq) Reset() {
	*x = UpdatePushTokenReq{}
	mi := &file_third_third_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdatePushTokenReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdatePushTokenReq) ProtoMessage() {}

func (x *UpdatePushTokenReq) ProtoReflect() protoreflect.Message {
	mi := &file_third_third_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdatePushTokenReq.ProtoReflect.Descriptor instead.
func (*UpdatePushTokenReq) Descriptor() ([]byte, []int) {
	return file_third_third_proto_rawDescGZIP(), []int{24}
}

func (x *UpdatePushTokenReq) GetPlatformID() int32 {
	if x != nil {
		return x.PlatformID
	}
	return 0
...
func (x *UpdatePushTokenReq) GetVendor() string {
	if x != nil {
		return x.Vendor
	}
	return ""
...
func (x *UpdatePushTokenReq) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *UpdatePushTokenReq) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *UpdatePushTokenReq) GetLocale() string {
	if x != nil {
		return x.Locale
	}
	return ""
...
func (x *UpdatePushTokenReq) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
func (x *UpdatePushTokenReq) GetExpireTime() int64 {
	if x != nil {
		return x.ExpireTime
	}
	return 0
...
type UpdatePushTokenResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdatePushTokenResp) Reset() {
	*x = UpdatePushTokenResp{}
	mi := &file_third_third_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdatePushTokenResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdatePushTokenResp) ProtoMessage() {}

func (x *UpdatePushTokenResp) ProtoReflect() protoreflect.Message {
	mi := &file_third_third_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdatePushTokenResp.ProtoReflect.Descriptor instead.
func (*UpdatePushTokenResp) Descriptor() ([]byte, []int) {
...
const file_third_third_proto_rawDesc = "" +
	...
	"expireTime\x18\x04 \x01(\x03R\n" +
	"expireTime\"\x14\n" +
	"\x12FcmUpdateTokenResp\"\xcc\x01\n" +
	"\x12UpdatePushTokenReq\x12\x1e\n" +
	"\n" +
	"platformID\x18\x01 \x01(\x05R\n" +
	"platformID\x12\x16\n" +
...
var file_third_third_proto_goTypes = []any{
	...
	(*UpdatePushTokenReq)(nil),          // 24: openim.third.UpdatePushTokenReq
	(*UpdatePushTokenResp)(nil),         // 25: openim.third.UpdatePushTokenResp
	...
	(*UploadLogsReq)(nil),               // 29: openim.third.UploadLogsReq
	(*UploadLogsResp)(nil),              // 30: openim.third.UploadLogsResp
	(*DeleteLogsReq)(nil),               // 31: openim.third.DeleteLogsReq
	(*DeleteLogsResp)(nil),              // 32: openim.third.DeleteLogsResp
