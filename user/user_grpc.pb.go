...
type UserClient interface {
	...
	// Who may be seen as online, and whose last-seen time may be shown,
	// decided per platform. Owned here because this service is the one
	// that answers getUserStatus and therefore has to enforce it. Writes
	// go to Mongo, then push a snapshot into Redis and publish on
	// cachekey.PresenceSettingsChannel so msggateway — which has no Mongo
	// of its own and pushes the live updates — enforces the same policy
...
func (c *userClient) GetPresenceSettings(ctx context.Context, in *GetPresenceSettingsReq, opts ...grpc.CallOption) (*GetPresenceSettingsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPresenceSettingsResp)
	err := c.cc.Invoke(ctx, User_GetPresenceSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) SetPresenceSettings(ctx context.Context, in *SetPresenceSettingsReq, opts ...grpc.CallOption) (*SetPresenceSettingsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetPresenceSettingsResp)
	err := c.cc.Invoke(ctx, User_SetPresenceSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) GetPresenceSettings(context.Context, *GetPresenceSettingsReq) (*GetPresenceSettingsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPresenceSettings not implemented")
}
...
func _User_GetPresenceSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPresenceSettingsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetPresenceSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_GetPresenceSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetPresenceSettings(ctx, req.(*GetPresenceSettingsReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_SetPresenceSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetPresenceSettingsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).SetPresenceSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_SetPresenceSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).SetPresenceSettings(ctx, req.(*SetPresenceSettingsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "getPresenceSettings",
			Handler:    _User_GetPresenceSettings_Handler,
		},
		{
